...
echo '<div style="height:250px;margin-top:-208px;position:absolute;top:90%;padding-left:5px;">To edit your pastedown, use the this edit code:<code class="code"><a href="/edit?edit_code=' . $db["pastes"][$_REQUEST['id']]["edit_code"] . "&id=" . $_REQUEST['id'] . '">' . $ini['domain'] .'/edit?edit_code=' . $db["pastes"][$_REQUEST['id']]["edit_code"] . "&id=" . $_REQUEST['id'] . '</a></code> or use this edit code:<code class="code">' . $db["pastes"][$_REQUEST['id']]["edit_code"] . '</code><b>Note:</b> Write the link and/or edit code down because you will never see it again.</div>'; 
    }
